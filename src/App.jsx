...
function App() {
  ...
  const [section,setSection] = useState(sectionsEnum[1])
  ...
  return (
    <>
        <section className='w-full flex justify-center items-center gap-5 mb-5 mt-2'>
            ...
            <BtnMenu type="congreso" setSectionState={setSectionState}>Congreso</BtnMenu>
        </section>
        ...
        {section === 'pre-congreso' && <>
            ...
            <div className='bg-custom-blue md:rounded-3xl p-2 w-full md:w-3/5 flex flex-col items-center gap-2 md:grid md:grid-cols-3 md:justify-items-start md:p-5'><p className='text-white'>12:00 PM - 01:00 PM</p><h2 className='text-white text-center'>COMIDA</h2></div>
        ...
        {section !== 'pre-congreso' && <>
              ...
              <div className='bg-custom-blue md:rounded-3xl p-2 
