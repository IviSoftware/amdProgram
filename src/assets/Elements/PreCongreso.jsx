...
function PreCongreso() {
  return ( <>
    ...
    <ContainerRows rows={7}>
        <RowTable hour="09:00 AM - 09:30 AM" doctor="Dr. Francisco Pérez Atamoroz" theme="TOXINA BOTULÍNICA" />
        <RowTable hour="09:30 AM - 09:45 AM" doctor={["Preguntas y respuestas", <br />, "Dr. Francisco Pérez Atamoros"]}   />
        <RowTable hour="09:45 AM - 10:15 AM" doctor="Dr. José Luis López Estebaranz" theme="RELLENOS" />
    ...
    <ContainerRows rows={3}>
        <RowTable hour="01:00 PM - 02:00 PM" doctor="Dr. Francisco Pérez Atamoroz" theme="PRÁCTICA" />
        <RowTable hour="02:00 PM - 03:00 PM" doctor="Dr. José Luis López Estebaranz"  theme="PRÁCTICA" />
