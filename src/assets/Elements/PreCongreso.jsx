...
function PreCongreso() {
  return ( <>
    ...
    <ContainerRows rows={7}>
        <RowTable hour="09:00 AM - 9:30 AM" doctor="Dr. Francisco Pérez Atamoroz" theme="TOXINA BOTULÍNICA" />
        <RowTable hour="09:30 AM - 9:45 AM" doctor={["Preguntas y respuestas", <br />, "Dr. Francisco Pérez Atamoros"]}   />
